...
<body>
    ...
    <ul class="list-section">
        ...
        <li>Our services cover accidental insurance; if any hospital case guests have to pay and the insurance company
            will reimburse after checking the documents. It is advisable for you to take an insurance cover for total
            travel including air.</li>
        <li>Any meals other than those mentioned in the menu.</li>
        <li>Any portage at airports and hotels, tips, insurance, wine, mineral water, telephone charges, and all items
            of personal nature.</li>
        <li>Expenses caused by factors beyond our control like rail and flight delays, roadblocks, vehicle malfunctions,
            political disturbances, etc.</li>
    ...
    <div class="note-block">
        <ul class="list-section">
            <li>The above package is only an offer and not a confirmation. We shall proceed with your booking only after
                we receive your confirmation.</li>
            <li>The airfare quoted, if any, is as of now and is subject to change.</li>
            <li>In case of non-availability of rooms at the hotels mentioned, we shall provide you alternate hotels of
                similar category.</li>
            <li>Check-in time at the hotel is 14:00/15:00 hrs &amp; Check-out time is 11:00/12:00 hrs as per the hotel
                policy.</li>
            ...
            <li>TIC Tours reserves the right to change/modify or terminate the offer any time at its own discretion and
                without any prior notice.</li>
            <li>Infants are free (Below 02 years / below 90 CM). If the height is more than 90 CM it is considered as a
                child &amp; the child height more than 120/130 CM is considered as an adult and pay the difference at
                the counter directly.</li>
            <li>All island tours and ferry transfers depend on the weather condition. If Pattaya Coral Island does not
                operate due to heavy waves/wind/thunderstorm we can refund THB 200 / USD 6 per person only.</li>
            <li>Normal Lunch/Dinner Menu: 2 Veg Main + 1 Non-Veg Main (Chicken or Fish) + 1 Dal + 1 Rice + Roti/Naan +
                Salad + Pickle + 1 Dessert + Drinking water.</li>
        </ul>
    </div>
    ...
    <div class="note-block">
        <ul class="list-section">
            <li>If cancellation is made any time not less than 16 days prior to departure, 20–30% of Package Cost shall
                be deducted.</li>
    ...
    <div class="note-block">
        <ol class="list-section">
            ...
            <li>For Indian Payment 5% GST is applicable and ROE will be xe.com +1.5 on the day of deposit. TCS
                Declaration is required.</li>
            <li>Every swift transaction adds USD 35 as bank charges. Outward Remittance charge to be borne by
                Transferor.</li>
