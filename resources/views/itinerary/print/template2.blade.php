...
<body class="antialiased">
    {{-- <div style="width: 100%; display: flex; justify-content: space-between;border: 2px solid black">
            <div style="width: 48%; text-align: left;border: 2px solid red">text1</div>
            <div style="width: 48%; text-align: right;border: 2px solid blue">text2</div>
        </div> --}}

    <table style="width: 100%;">
        <tr>
            <td style="float: left;width:80%">
                <img src="logo-n-bg.png" width="250px" />
            </td>
            <td style="float: right; text-align: left;width:20%;">
                WWW.TICTOURS.COM<br>
                +91 7736696937<br>
                +91 7736696937<br>
                SALES@TICTOURS.COM
        ...
        <tr>
            <td colspan="2" style="float: right; text-align: left;line-height:25px">
                <span>
                    ...
                    COMPANY. WE
                    HEREBY FORWARD YOU THE COMPLETE PACKAGE TOUR PLAN WITH ALL DETAILS, FOR FURTHER CLARIFICATION, OR
                    CHANGE
                    AS PER YOUR IDEA OR PLANNING PLEASE DO CALL OR MAIL US.
                </span>
            </td>
        </tr>
    </table>
    ...
    <table class="border-table" style="width: 100%;margin-top:8px;margin-bottom:10px">
        ...
        <tr>
            ...
            @php
                ...
                $count = $daysCount - 1 . ' Nights & ' . $daysCount . ' Days';
    ...
    <span
        style="font-size: 17px;margin-top:10px;margin-bottom:10px;font-weight:400">{{ $itinerary->package_name }}</span>

    @foreach ($itinerary->entries->where('entry_type', 'HOTEL') as $item)
        <table class="border-table" style="width: 100%;margin-top:10px;">
            <tbody>
                <tr style="border:1px solid #50BDFF !important">
                    <td colspan="7"
                        style="background-color: #50BDFF;color:white;border:1px solid #50BDFF !important">
                        {{ $item->option }}</td>
                </tr>
                <tr style="background-color: #E4E4E4;color:white;border:1px solid #E4E4E4 !important">
                    <td width="10%">City</td>
                    <td width="33%">Hotel Name</td>
                    <td width="12%">Check In</td>
                    <td width="12%">Check Out</td>
                    <td width="10%">Nights</td>
                    <td width="13%">Room Type</td>
                    <td width="10%">Meal Plan</td>
                </tr>
                ...
                <tr>
                    ...
                    @php
                        $hotel = Modules\Settings\Entities\Hotel::find($itinerary->subject_id);
                    @endphp

                    <td>{{ optional($hotel)->name }}</td>
                    ...
                    @php
                        ...
                        $nightsCount = $end->diffInDays($start) - 1;
        ...
        @php
            ...
            foreach ($itinerary->entries as $key => $entry) {
                ...
                if($entry->entry_type=='HOTEL'){
                    ...
                    $childWPerPersonNetAmount += $room->child_w_bed_amount;
                    $childNPerPersonNetAmount += $room->child_n_bed_amount;
                }
        ...
        <div style="width: 100%; display: flex; justify-content: space-between;margin-top:10px">
            <div style="text-align: center;font-size:22px;font-weight:800">{{ $item->option }} - Per Person Package
                price : <span style="color:red">{{ round($adultPerPersonAmount, 2) }} INR , Child W - {{ round($childWPerPersonAmount,2 )}} INR , Child N - {{ round($childNPerPersonAmount,2 )}} INR</span></div>
        </div>
    @endforeach

    {{-- <table class="border-table" style="width: 100%;margin-top:10px;">
        <tbody>
            <tr style="border:1px solid #04BF58 !important">
                <td colspan="7" style="background-color: #04BF58;color:white;border:1px solid #04BF58 !important">
                    Option 2</td>
            </tr>
            <tr style="background-color: #E4E4E4;color:white;border:1px solid #E4E4E4 !important">
                <td width="10%">City</td>
            ...
            <tr>
                <td>Dubai</td>
                <td>Dolphin hotel apartments (3 star)</td>
                <td>01-Sep-2023</td>
                <td>01-Oct-2023</td>
                <td>6</td>
                <td>Studio Room</td>
    ...
    <div style="width: 100%; display: flex; justify-content: space-between;margin-top:10px">
        <div style="text-align: center;font-size:22px;font-weight:800">Option 2 - Per Person Package price : <span
                style="color:red">4,620 INR</span></div>
    </div> --}}
