...
class EnquiriesController extends BaseController
{
    ...
    public function index()
    {
        try {
            ...
            if (!$role) {
                $enquiry = Enquiry::with(['agent', 'destination', 'sub_destinations', 'sub_destination', 'customer', 'assigned_to_user', 'lead_source', 'requirements', 'itineraries', 'priority'])->latest()->get();
            ...
            $enquiry = $query->with(['agent', 'destination', 'sub_destinations', 'sub_destination', 'customer', 'assigned_to_user', 'lead_source', 'requirements', 'itineraries', 'priority'])->latest()->get();
            return $this->sendResponse(EnquiryResource::collection($enquiry), 'All Enquiries Fetched', 200);
    ...
    {
        try {
            $enquiry = Enquiry::with(['agent', 'destination', 'sub_destinations', 'sub_destination', 'customer', 'assigned_to_user', 'lead_source', 'requirements', 'itineraries', 'priority'])->findOrFail($id);
